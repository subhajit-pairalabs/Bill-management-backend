/**
 * @file repositories/subscription.repository.js
 * @description Subscription data access: find plan by user, insert/update subscription record, log billing events
 *
