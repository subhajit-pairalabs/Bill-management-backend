/**
 * @file controllers/family.controller.js
 * @description HTTP boundary controller for: Family Vault: vault CRUD, member invite, role update, member removal, vault bill listing
 *
