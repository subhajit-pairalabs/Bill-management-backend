/**
 * @file queues/ocr.queue.js
 * @description BullMQ Queue instance (PRODUCER side).
 * Queue: ocr
 * OCR processing. Payload: { billId, r2Key, userId }. Triggered by: bill.service after successful upload.
 *
 ...
 * The CONSUMER is: workers/ocr.worker.js
 *
