/**
 * @file services/category.service.js
 * @description Category logic: list system and user categories, create/update/delete custom categories, enforce uniqueness per user
 *
 * Service layer rules:
