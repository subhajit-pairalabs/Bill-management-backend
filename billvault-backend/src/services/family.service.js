/**
 * @file services/family.service.js
 * @description Family Vault logic: create vault, generate invite link/code, process invite acceptance, assign/update roles, remove members, enforce plan limits
 *
 * Service layer rules:
